---
name: git-workflow
description: "在需要 commit、branch 或 push 的 Git 操作前，套用安全規則與統一格式。"
...
- commit message 不得含 `Co-Authored-By`、`Generated by` 或其他 AI
  attribution；`hooks/commit-attribution-guard.sh` 會強制擋下
