...
- Route by capability: keep routine and pure-judgment work on the current
  bindings; reserve Astra candidates for explicit tool, cross-system,
  long-horizon, or disagreement evidence.
