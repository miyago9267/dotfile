---
name: git-workflow
description: "需要 commit、branch 或 push 的 Git 操作前，套用安全規則與統一格式。"
when_to_use: "只在即將執行 state-changing Git operation 時觸發。"
tags: [git, commit, branch, push, safety]
effort: low
shell: required
...
- commit message 不得含 `Co-Authored-By`、`Generated by` 或其他 AI attribution
