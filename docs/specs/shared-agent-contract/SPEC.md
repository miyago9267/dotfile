...
- **R25**: When shared skill logic spans multiple runtimes, the contract shall preserve intent across Claude, Gemini, and Codex even when their file formats differ
- **R26**: When a runtime lacks a direct equivalent format, the contract shall still copy the core trigger, boundary, and behavior into the nearest native entrypoint
...
- Update: `config/ai/codex/AGENTS.md` (as needed for runtime-specific carry-over)
